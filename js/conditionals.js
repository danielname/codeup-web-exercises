 ...
 */
// fucntion analyzeColor(colorString) {
//     if (colorString === "red") {
//         return "Blood is red.";
//     } else if (colorString === "orange") {
//         return "Nothing rhymes with orange.";
//     } else if (colorString === "yellow") {
//         return "My rubber duck is yellow.";
//     } else if (colorString === "green") {
//         return "green is my favorite color.";
//     } else if (colorString === "blue") {
//         return "I'm blue da ba dee da ba dai.";
//     } else if (colorString === "indigo") {
//         return "The Elite Four can be fought at the indigo plateau.";
 ...
 */
let colorInput = prompt("Pick a color, any color.");
